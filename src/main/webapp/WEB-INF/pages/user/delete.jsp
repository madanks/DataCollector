...
<c:url value="/admin/user/delete.html" var="action" />
<%@taglib uri="http://www.springframework.org/tags/form" prefix="form"%>
								...
								<div class="row">
									<div class="col-md-6">
										...
										<div class="form-group">
											...
											<div>
												<form:input path="userInfo.lastName" readonly="true"
													class="form-control" name="firstname"
													data-parsley-required="true" data-parsley-trigger="change"
										...
										<div class="form-group">
											<label>Address</label>
											<div>
												<form:input path="userInfo.address" readonly="true"
													class="form-control" name="firstname"
													data-parsley-required="true" data-parsley-trigger="change"
													placeholder="Address" />
											</div>
										...
										<div class="form-group">
											<label>Email</label>
											<div>
												<form:input path="userInfo.email" readonly="true"
													class="form-control" name="email" data-parsley-type="email"
													data-parsley-required="true" data-parsley-trigger="change"
										...
										<div class="form-group">
											...
											<div>
												<form:input path="userInfo.phone" readonly="true"
