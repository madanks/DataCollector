...
<c:url value="/inspector/inspection/delete.html" var="action" />
<%@taglib uri="http://www.springframework.org/tags/form" prefix="form"%>
								...
								<div class="row">
									...
									<%-- 	<div class="form-group">
										...
										<div class="form-group">
											...
											<div>
												<form:textarea path="note" class="form-control" rows="5" readonly='true'
										...
										<div class="form-group text-center">
											<label></label>
											<div>
												<input type="submit" value="Delete Inspection"
