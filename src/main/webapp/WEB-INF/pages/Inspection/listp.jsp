	...
	<div class="content-wrap">
		...
		<div class="wrapper">
			<section class="panel panel-default"> <header
				class="panel-heading"><b>Pending Inspections</b></header>
							...
							<c:forEach var="d" items="${draft}">
								<tr>
									...
									<td style='text-decoration: underline;'><a
										href="editp/${d.id}">Edit</a></td>
									<td style='text-decoration: underline;'><a
										href="delete/${d.id}">Delete</a></td>
									<td style='text-decoration: underline;'><a
										href="${pageContext.request.contextPath}/supervisor/inspection/approve/${d.id}">Approve</a></td>
									<td style='text-decoration: underline;'><a
										href="pinspect/${d.manufacturer}/${d.temptype}/${d.tempname}/${d.id}">Inspect</a></td>
									<td style='text-decoration: underline;'><a
