			...
			<div class="panel-body">
				...
				<div class="table-responsive no-border">
					...
					<table
						...
						<tbody>
							<c:forEach var="TempMast" items="${objListTemplateHeaders}">
								<tr>
									<td>${TempMast.temp_name}</td>
									<td>${TempMast.temp_type}</td>
									<td>${TempMast.templateNumber}</td>
									<td>${TempMast.version}</td>
									<td>${TempMast.manufacturer}</td>
									<td>${TempMast.category}</td>
									<td>${TempMast.model}</td>
									<td>${TempMast.status}</td>
									<td>${TempMast.updatedDate}</td>
									<td>${TempMast.year}</td>

									<td  style='text-decoration:underline;'><a href="edit/${TempMast.mrecordID}">Edit</a></td>
									<td  style='text-decoration:underline;'><a href="delete/${TempMast.mrecordID}">Delete</a></td>
									<td  style='text-decoration:underline;'><a
										href="${pageContext.request.contextPath}/inspector/templatedetail/details/${TempMast.mrecordID}">Details</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
